...
model = dict(
    ...
    gaussian_att_cluster_head=dict(
        ...
        fea_height=att_size,
        fea_width=att_size,
        loss_weight=dict(loss_sim=5, loss_ent=3, loss_rel=1, loss_att=5, loss_prior=0, loss_mi=2),
        lamda=0.05,
        num_att_map=1,
    ),

    weight=None,  # "/home/ljm/NiuChuang/projects/deep-cluster/results/stl10/dac/model_0000220.pth",
)
